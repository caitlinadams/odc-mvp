...
# S1 Test Data -- VV+VH from Ecocene and ASPA
# datacube product add /src/dea-config/products/baseline_satellite_data/s1_gamma0/ga_s1_iw_vv_vh_c0.odc-product.yaml

# s3-to-dc --stac --no-sign-request s3://deant-data-public-dev/experimental/stac_for_ows/ga_s1_iw_vv_vh_c0/**/metadata.json
